...
function useRx(stream, initialValue, onErr, onComplete) {
    // Output state
    var _a = react_1.useState(undefined), outState = _a[0], _setOutState = _a[1];
...
function useRxState(initialValue, pipes, onErr, onComplete) {
    // input to stream
    var emitterRef = react_1.useRef(null);
    // Output state
    var _a = react_1.useState(undefined), state = _a[0], _setState = _a[1];
    react_1.useEffect(function () {
